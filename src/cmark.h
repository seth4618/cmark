 ...
 */
  ...
  typedef enum {
    ...
    CMARK_NODE_ATTRIBUTE,
    CMARK_NODE_CODE,
    CMARK_NODE_INLINE_HTML,
    CMARK_NODE_QUESTION,	/* new node which will format as a question (or sub-question, etc. */
    CMARK_NODE_ANSWER,	/* new node which will format as one answer to a multiple choice type exam quest */
    CMARK_NODE_BLANK,	/* new node which will format into a blank space */
    CMARK_NODE_EMPH,
    CMARK_NODE_STRONG,
    CMARK_NODE_LINK,
    /* New Nodes */
...
/** Frees the memory allocated for a node and all its children and younger siblings.
 */
CMARK_EXPORT void
cmark_tree_free(cmark_node *node);
...
/** produce exam output
 */
#define CMARK_OPT_EXAM 16
/** produce output to files
 */
#define CMARK_OPT_USEFILES 32
...
#define NODE_QUEST		  CMARK_NODE_QUESTION
#define NODE_EXAM		  CMARK_NODE_EXAM
...
#define NODE_ATTRIBUTE		  CMARK_NODE_ATTRIBUTE
